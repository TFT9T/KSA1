...
[['text'=>"✵⁞ مبرمج السورس ⁞✵",'url'=>"t.me/bbqq8"]],
]])
]); 
}
if($data == "nd3" ){
...
'chat_id'=>$chat_id2,
'message_id'=>$message_id2,
'text'=>"⋄︙مـا هـي عـاصـمـة الـسـعـوديـه",
'parse_mode'=>'MarkDown',
'disable_web_page_preview'=>true,
"reply_markup"=>json_encode([
"inline_keyboard"=>[
[['text'=>'✵⁞ جده ⁞✵' ,'callback_data'=>"nb1"]],
[['text'=>'✵⁞ الرياض ⁞✵' ,'callback_data'=>"mai2"]],
[['text'=>'✵⁞ مكه المكرمه ⁞✵' ,'callback_data'=>"nb"]],
[['text'=>'✵⁞ الغاء ⁞✵' ,'callback_data'=>"deletmil"]],
]])
]); 
}
